...
all: test_gamepad_SDL2 map_gamepad_SDL2 gamepad_info sdl_ra_joystick_map
...
sdl_ra_joystick_map: sdl_ra_joystick_map.cpp
	gcc -g -o sdl_ra_joystick_map sdl_ra_joystick_map.cpp -lstdc++ -lSDL2

clean:
	rm -f test_gamepad_SDL2
	rm -f map_gamepad_SDL2
	rm -f gamepad_info
	rm -f sdl_ra_joystick_map